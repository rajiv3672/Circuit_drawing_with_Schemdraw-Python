...
with schemdraw.Drawing() as d:
    ...
    d += (l1 := elm.Line().right().at(R4.start).length(1.3))
    d += (Ce := elm.Capacitor().down().at(l1.end).label('$C_E$\n$1\mu F$'))
